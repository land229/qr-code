...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @Assert\IsTrue(message="Vous devez accepter la politique de confidentialité et les conditions.")
     */
     ...
     */
    // relation with QrCode entity now uses property named "user" on QrCode
